"""
Base Django settings for Healthcare Backend Project.
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'core.shared.pagination.StandardPagination',
    'PAGE_SIZE': 10,
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@healthcare.com')
